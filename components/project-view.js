                  ...
                  <Box w="100%" display="flex" justifyContent="center">
                    {
                      project['platform']==='web' ? (
                        <WebFrame>
                          <Image fit="cover" align="0 0" src={project['screenshot']} />
                        </WebFrame>
                      ) : (
                        <MobileFrame>
                          <Image fit="cover" align="0 0" src={project['screenshot']} />
              ...
              <Wrap spacing={[2, 2]} shouldWrapChildren>
                {
                  [ ...project['tags']].map((tag, index) => (
                    <SectionItem key={index}>
                      <Tag size="sm" fontSize={{ base: "x-small" }} borderRadius={2} border="2px solid" borderColor={useColorModeValue('gray.800', 'gray.100')}
                        color={useColorModeValue('gray.800', 'gray.100')} bg={useColorModeValue('gray.300', 'gray.600')}
                      >
                        { tag }
                      </Tag>
                    </SectionItem>
